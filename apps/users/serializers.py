...
class VerificacaoDocumentoAdminSerializer(serializers.ModelSerializer):
    """
    Serializer para visualização de documentos pendentes de verificação pelo admin
    """
    profile_photo = serializers.SerializerMethodField()
    documento_foto = serializers.SerializerMethodField()
    nome_completo = serializers.SerializerMethodField()
    data_solicitacao = serializers.DateTimeField(source='date_joined', read_only=True)
    ...
    def get_documento_foto(self, obj):
        if obj.documento_foto:
            return obj.documento_foto.url
        return None
