"""
Views do módulo de Transferências
"""
...
class TransferRequestCreateView(generics.CreateAPIView):
    """View para criar solicitação de transferência"""
...
class TransferRequestListView(generics.ListAPIView):
    """View para listar transferências do usuário"""
    serializer_class = TransferRequestSerializer
    permission_classes = [IsAuthenticated]
...
class TransferRequestDetailView(generics.RetrieveUpdateAPIView):
    """View para detalhes e atualização de transferência"""
    queryset = TransferRequest.objects.all()
    serializer_class = TransferRequestSerializer
    permission_classes = [IsAuthenticated]
