...
from .serializers import CustomTokenSerializer, UserSerializer, EventoSerializer, InscricaoCreateSerializer, InscricaoSerializer, EventSerializer, RegistrationSerializer, AvaliacaoSerializer
