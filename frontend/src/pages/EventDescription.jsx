    ...
    return (
        <div className="bg-gray-50 min-h-screen py-6 px-2 md:px-0">
            <div className="max-w-7xl mx-auto bg-white rounded-xl shadow p-6 md:p-14">
                ...
                <div className="flex items-center mb-4" onClick={() => navigate("/")}>
                    <EventButton
                        className="bg-white border border-gray-300 text-gray-700 hover:bg-gray-100 flex items-center gap-2 px-3 py-1 text-sm mr-2 hover:cursor-pointer">
                        <FaArrowLeft/>
                        <button
                ...
                <div className="mb-8">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex gap-4 mt-2 md:mt-0">
                            <EventButton
                                className="bg-green-600 text-white hover:bg-green-700 flex items-center gap-2 px-8 py-3 text-lg hover:cursor-pointer "><FaCheckCircle/> SE
                                INSCREVER</EventButton>
                            <EventButton
                                className="bg-yellow-400 text-white hover:bg-yellow-500 flex items-center gap-2 px-8 py-3 text-lg hover:cursor-pointer"><FaUser/> FILA
                                DE ESPERA</EventButton>
                            <EventButton
                                className="bg-gray-100 text-gray-700 hover:bg-gray-200 flex items-center gap-2 px-8 py-3 text-lg hover:cursor-pointer"><FaShareAlt/> COMPARTILHAR</EventButton>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2 mt-4 mb-6">
                        ...
                        <InfoItem icon={<FaMapMarkerAlt className="text-primary"/>}>Centro de Convenções - São
                            Paulo</InfoItem>
                    </div>
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-2 text-gray-700">
                        Aprenda os fundamentos do UX Design neste workshop prático e intensivo. Durante 4 horas, você
                        irá descobrir como criar experiências digitais que realmente importam para os usuários.
                    </p>
                    ...
                    <div className="mt-2">
                        <a href="#" className="text-primary underline text-xs">Clique para acessar as políticas de
                            cancelamento</a>
                    </div>
                </section>
                <section className="mb-8">
                    <div className="flex items-center gap-4 bg-gray-100 rounded-lg p-4">
                        <div
                            className="w-14 h-14 rounded-full bg-gray-300 flex items-center justify-center text-2xl text-gray-500 hover:cursor-pointer">
                            <FaUser/>
                        </div>
                        <div className="flex-1">
                            <div className="font-semibold text-gray-900 hover:cursor-pointer">João Designer</div>
                            <div className="flex items-center gap-1 text-yellow-500 text-sm">
                                <FaStar/> 5.0 <span className="text-gray-500">(127 avaliações)</span>
                            </div>
                            <div className="text-xs text-gray-600">Designer UX/UI com 6 anos de experiência em produtos
                                digitais
                            </div>
                        </div>
                    ...
                    <div className="w-full h-56 rounded-lg overflow-hidden">
                        <LoadScript googleMapsApiKey={import.meta.env.VITE_GOOGLE_MAPS_API_KEY || "SUA_CHAVE_AQUI"}>
                            <GoogleMap
                                ...
                                center={{lat: -23.59623658854046, lng: -46.682372360456675}}
                                zoom={14}
                                options={{
                ...
                <section className="mb-8">
                    <div className="flex flex-col md:flex-row md:items-stretch md:gap-8 w-full">
                        <div className="flex-1">
                            <h3 className="font-semibold mb-4 uppercase text-base tracking-tight">Avaliação de eventos
                                anteriores</h3>
                            <div className="flex flex-col gap-0">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="flex items-center gap-4 py-2">
                                        <div
                                            className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-lg text-gray-500 mr-2">
                                            <FaUser/></div>
                                        <div className="flex flex-col flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 text-sm">Maria Silva</span>
                                                <span
                                                    className="flex items-center text-yellow-500 text-xs font-semibold">{[...Array(5)].map((_, i) => (
                                                    <FaStar key={i}/>))}</span>
                                            </div>
                                        ...
                                        <span
                                            className="text-xs text-gray-500 whitespace-nowrap ml-2">Há 2 semanas</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div
                            className="flex flex-col items-center justify-center min-w-[180px] md:justify-center md:self-center">
                            <div className="flex flex-col items-center justify-center h-full">
                                <span className="text-4xl font-bold text-gray-900 leading-none">4.8</span>
                                <span
                                    className="flex items-center text-yellow-500 text-xl mb-1">{[...Array(5)].map((_, i) => (
                                    <FaStar key={i}/>))}</span>
                ...
                <div className="mt-8">
                    <EventButton
                        className="w-full bg-gray-900 text-white hover:bg-gray-800 py-6 text-2xl flex items-center justify-center gap-3 rounded-lg hover:cursor-pointer">
